/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bdb0d031eae47bb3bb41902a60f03ea3)
// Runtime types generated with workerd@1.20250902.0 2025-03-01 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		GALLERY_KV: KVNamespace;
		CASES_KV: KVNamespace;
		NEXT_PUBLIC_APP_URL: "https://bananaprompts.info";
		NEXT_PUBLIC_APP_NAME: "Banana Prompts";
		NEXT_PUBLIC_THEME: "default";
		NEXT_PUBLIC_APPEARANCE: "dark";
		DATABASE_URL: "postgresql://postgres.rvkrgexitjwfqvfhnbck:QgPUIJzjTl7RpiR9@aws-1-ap-south-1.pooler.supabase.com:5432/postgres";
		DATABASE_PROVIDER: "turso";
		DB_SINGLETON_ENABLED: "false";
		AUTH_SECRET: "g+oQ7CjBRQYOl3/ylLPgdKCTipXMNIz91GgFMaY3LVI=";
		NEXTJS_ENV: string;
		DB: D1Database;
