...
export async function middleware(request: NextRequest) {
  ...
  // 🚀 PERFORMANCE: Delete Set-Cookie for public routes to enable CDN caching
  // Without this, next-intl's NEXT_LOCALE cookie makes Cloudflare treat every
  // request as dynamic, completely bypassing edge cache → TTFB spikes to 1.4s+
