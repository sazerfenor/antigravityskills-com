...
// ============================================
// Server-side cookie utilities (for auth hooks)
// ============================================

/**
 * Parse a cookie value from a cookie header string
 * @param cookieHeader The raw cookie header (e.g., "a=1; b=2; utm_source=xxx")
...
/**
 * Get a header value from a context object (supports various ctx shapes)
 * @param ctx Context object (may have headers as object or Headers instance)
...
/**
 * Get a cookie value from a context object (Better-Auth databaseHooks)
 * @param ctx Context object from Better-Auth hooks
 * @param name Cookie name
 */
...
/**
 * Guess locale from Accept-Language header
 * @param acceptLanguage The Accept-Language header value
 * @returns Two-letter language code (e.g., "zh", "en")
 */
