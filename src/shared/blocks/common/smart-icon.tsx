...
// Discord icon (not in lucide-react, using inline SVG)
...
// Static icon mapping for O(1) lookup - uses lucide-react for tree-shaking
const ICON_MAP: Record<string, ComponentType<any>> = {
  ...
  // Mapped from react-icons to lucide equivalents
  RiRobot2Line: Bot,
  RiImage2Line: ImageIcon,
  RiMusic2Line: Music,
  RiQuestionLine: HelpCircle,
  RiMessage2Line: MessageSquare,
  ...
  RiGoogleFill: GoogleIcon,
  RiNextjsFill: Code, // Fallback to Code icon
};
