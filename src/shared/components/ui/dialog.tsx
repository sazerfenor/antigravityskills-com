...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        // CBDS v2.1 Protocol 3: Grid centering instead of fixed positioning
    ...
    <DialogPortal data-slot="dialog-portal">
      <DialogOverlay>
        <DialogPrimitive.Content
          ...
          className={cn(
            // CBDS v2.1 Protocol 3: Relative positioning, grid container handles centering
            "relative z-50 w-full max-w-lg grid gap-4 p-6",
            // Base glass effect with solid dark background
