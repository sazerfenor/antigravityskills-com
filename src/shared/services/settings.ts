...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    },
    {
      ...
      title: t('groups.initial_credits'),
...
export async function getSettings() {
  const settings: Setting[] = [
    ...
    // Initial Credits Settings
    {
      ...
      type: 'switch',
      value: 'false',
      tip: 'Grant credits to new users when they register',
      group: 'initial_credits',
      tab: 'auth',
    },
    {
      ...
      type: 'number',
      placeholder: '10',
      tip: 'Number of credits to grant to new users',
      group: 'initial_credits',
      tab: 'auth',
    },
    {
      ...
      type: 'number',
      placeholder: '30',
      tip: 'Number of days before credits expire (0 = never expires)',
      group: 'initial_credits',
      tab: 'auth',
    },
    {
      ...
      tip: 'Description shown in user credit history',
      group: 'initial_credits',
      tab: 'auth',
    },
    {
  ...
  "premium-yearly": "promo_xxx"
    ...
    },
    {
      ...
      type: 'switch',
      value: 'false',
      tip: 'Allow user to input promotion code in checkout page.',
      group: 'stripe',
      tab: 'payment',
    },
    {
