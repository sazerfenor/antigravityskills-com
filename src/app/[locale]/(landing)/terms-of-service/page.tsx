...
export const metadata: Metadata = getPolicyMetadata('Terms of Service');
...
export default async function TermsOfServicePage({
  ...
  // Get MDX content from content/pages/en/terms-of-service.mdx
  const page = await getLocalPageWithBody({ slug: 'terms-of-service', locale });
