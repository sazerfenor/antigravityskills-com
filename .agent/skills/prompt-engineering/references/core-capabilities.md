...
Detailed reference for prompt engineering techniques.
...
**Process:**
1. Start simple
2. Measure performance (accuracy, consistency, token usage)
3. Iterate based on results
4. Test on diverse inputs including edge cases
...
**Use when:**
- Same pattern applies to different inputs
...
**Include:**
- Model's role and expertise level
- Output format requirements
- Safety guidelines
- Stable instructions that shouldn't change turn-to-turn
