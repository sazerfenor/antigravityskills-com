---
description: Debug authentication issues with API routes including 401/403 errors, JWT problems, cookie issues, and route registration conflicts
---

> **Original Full Description (from Claude Agent)**:
...
- **Context**: User is experiencing authentication issues with an API route
  ...
  - **Agent Response**: "I'll use the auth-route-debugger agent to investigate this authentication issue"
...
- **Context**: User reports a route is not being found despite being defined
  ...
  - **Agent Response**: "Let me launch the auth-route-debugger agent to check the route registration and potential conflicts"
...
- **Context**: User needs help testing an authenticated endpoint
  ...
  - **Agent Response**: "I'll use the auth-route-debugger agent to test this authenticated endpoint properly"
