---
description: Fix frontend errors - build-time (TypeScript, bundling) and runtime (browser console, React errors, network issues)
---
...
- **Context**: User encounters an error in their React application
  ...
  - **Agent Response**: "I'll use the frontend-error-fixer agent to diagnose and fix this runtime error"

- **Context**: Build process is failing
  - **User**: "My build is failing with a TypeScript error about missing types"
  - **Agent Response**: "Let me use the frontend-error-fixer agent to resolve this build error"
...
- **Context**: User notices errors in browser console while testing
  ...
  - **Agent Response**: "I'll launch the frontend-error-fixer agent to investigate these console errors using the browser tools"
