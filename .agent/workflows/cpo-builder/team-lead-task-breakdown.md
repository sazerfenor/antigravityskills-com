...
7. **Generate Task Breakdown Document**
   ...
   - Load and reference .agent/doc/templates/technical-task-template.md for task formatting
...
- Follow the .agent/doc/templates/technical-task-template.md structure exactly
...
For each task, follow the .agent/doc/templates/technical-task-template.md structure exactly:
...
- **Format**: Follow the structure from `.agent/doc/templates/technical-task-template.md`
...
1. **Read Template**: Load `.agent/doc/templates/technical-task-template.md` using Read tool
...
.agent/
  templates/
    ...
    prp_document_template.md      # PRP template
docs/
  tasks/
